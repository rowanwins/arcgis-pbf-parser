...
export const esriPBuffer = $root.esriPBuffer = (() => {
  ...
  esriPBuffer.FeatureCollectionPBuffer = (function() {
    ...
    FeatureCollectionPBuffer.decode = function decode(reader, length) {
      ...
      const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer();
    ...
    FeatureCollectionPBuffer.SpatialReference = (function() {
      ...
      SpatialReference.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.SpatialReference();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Field = (function() {
      ...
      Field.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Field();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Value = (function() {
      ...
      Value.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Value();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Geometry = (function() {
      ...
      Geometry.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Geometry();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 2:
    ...
    FeatureCollectionPBuffer.esriShapeBuffer = (function() {
      ...
      esriShapeBuffer.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.esriShapeBuffer();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Feature = (function() {
      ...
      Feature.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Feature();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.UniqueIdField = (function() {
      ...
      UniqueIdField.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.UniqueIdField();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.GeometryProperties = (function() {
      ...
      GeometryProperties.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.GeometryProperties();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Scale = (function() {
      ...
      Scale.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Scale();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Translate = (function() {
      ...
      Translate.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Translate();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.Transform = (function() {
      ...
      Transform.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.Transform();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.FeatureResult = (function() {
      ...
      FeatureResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.FeatureResult();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
    ...
    FeatureCollectionPBuffer.QueryResult = (function() {
      ...
      QueryResult.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        const end = length === undefined ? reader.len : reader.pos + length, message = new $root.esriPBuffer.FeatureCollectionPBuffer.QueryResult();
        while (reader.pos < end) {
          const tag = reader.uint32();
          switch (tag >>> 3) {
          case 1:
